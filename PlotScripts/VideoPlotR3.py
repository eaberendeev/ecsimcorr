...
f = open("R"+str((i-iStep)*6)+".txt", 'w')
f.write("r Bz densE densI PppE PppI PrrE PrrI JphiE JphiI")
f.write("\n")
R = dataR["Bz"].shape[0] - 1
for i in range(dataR["Bz"].shape[0]):
    f.write(str((R-i)*float( SystemParameters['Dx'])) + " " + str(dataR["Bz"][R-i]) + " " + str(dataR["ElectronsDens"][R-i]) + " " + str(dataR["IonsDens"][R-i]) + " " + str(dataR["ElectronsPpp"][R-i]) + " " + str(dataR["IonsPpp"][R-i]) + " " + str(dataR["ElectronsPrr"][R-i]) + " " + str(dataR["IonsPrr"][R-i]) + " " + str(dataR["ElectronsJphi"][R-i]) + " " + str(dataR["IonsJphi"][R-i]))
    f.write("\n")
f.close()
