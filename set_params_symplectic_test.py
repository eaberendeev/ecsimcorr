...
CurrentSimulation = "symplectic" #"ecsim"
...
DirName = "ResPeriodicPerf4_"+str(NumProcs)
DEBUG = False

Dx = 0.1 # step on X
Dy = Dx # step on Y
Dz = Dx # step on Z
Dt = 0.05 #4*min(Dx,Dy)  # time step
...
MaxTime = 10000000 # in 1/w_p
RecTime = 6000000 #

Tau = 4998


DiagDelay2D = 200 # in 1 / w_p
...
PartDict["DistType"] = "INITIAL" #"INJECTION"
...
PartDict["DistType"] = "INITIAL" #"INITIAL"
# PartDict["DistSpace"] = ["UniformCylZ_cx_cy_cz_rr_rz", 
#                          0.5*NumCellsX_glob*Dx, 
#                          0.5*NumCellsY_glob*Dy, 
#                          0.5*NumCellsZ_glob*Dz,
