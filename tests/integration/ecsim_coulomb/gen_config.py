#!/usr/bin/env python3
# Integration test: ecsim with Coulomb collisions (e-e, i-i, e-i).
# Verifies the simulation runs with all collision types and energy is conserved.
