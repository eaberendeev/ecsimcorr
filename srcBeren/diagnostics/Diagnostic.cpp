...
void Diagnostics::output_energy_spectrum(const EnergySpectrum& spectrum, int timestep,
    ...
    filename << output_dir << "/energy_spectrum_" << std::setw(6) << std::setfill('0') << timestep << ".txt";
    ...
    for (int i = 0; i < num_bins; ++i) {
        ...
        outfile << energy_center << " " << spectrum.spectrum[i] << "\n";
    }
}
