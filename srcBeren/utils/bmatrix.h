...
inline constexpr int indX(int i, int j, int k) {
    return i * (BlockDims::X::SIZE_J * BlockDims::X::SIZE_K) + j * BlockDims::X::SIZE_K + k;
}

inline constexpr int indY(int i, int j, int k) {
    return i * (BlockDims::Y::SIZE_J * BlockDims::Y::SIZE_K) + j * BlockDims::Y::SIZE_K + k;
}

inline constexpr int indZ(int i, int j, int k) {
    return i * (BlockDims::Z::SIZE_J * BlockDims::Z::SIZE_K) + j * BlockDims::Z::SIZE_K + k;
}
...
void processComponent(int i_cell, int j_cell, int k_cell, const Block_t& block, std::vector<Triplet>& trips,
