...
class SimulationSymplectic : public Simulation {
   public:
    SimulationSymplectic(const ParametersMap& _systemParameters, const std::vector<ParametersMap>& _speciesParameters,
    ...
    void move_x(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                const double dt);
    void move_y(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                const double dt);
    void move_z(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                const double dt);
    void move_x_orig(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                     const double dt);
    void move_y_orig(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                     const double dt);
    void move_z_orig(std::unique_ptr<ParticlesArray>& particlesArray, const Field3d& fieldB, Field3d& fieldJ,
                     const double dt);
    void update_velocity(std::unique_ptr<ParticlesArray>& particlesArray, const double dt);
